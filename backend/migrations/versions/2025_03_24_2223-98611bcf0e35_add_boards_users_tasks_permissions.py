"""Add boards, users, tasks, permissions

Revision ID: 98611bcf0e35
Revises:
Create Date: 2025-03-24 22:23:04.622852
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("board_id", "user_id", name=op.f("pk_permissions")),
    )
    op.create_table(
        "tasks",
        sa.Column("id", sa.UUID(), nullable=False),
